        ...
        <div class="row">
          <div class="col-lg-4 col-md-6 mb-5">
            <div class="product-item">
              ...
              <div class="px-4">
                <h3><a href="#">sandwichs</a></h3>
                <p class="mb-4">Lorem ipsum dolor sit amet, consectetur adipisicing.</p>
                <div>
                  <a href="#" class="btn btn-black mr-1 rounded-0">Commander</a>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 mb-5">
            <div class="product-item">
              ...
              <div class="px-4">
                ...
                <p class="mb-4">Lorem ipsum dolor sit amet, consectetur adipisicing.</p>
                <div>
                  <a href="commande.php" class="btn btn-black mr-1 rounded-0">Commander</a>
                </div>
              </div>
            </div>
          </div>
            ...
            <form action="#" class="p-5 bg-white">
              ...
              <div class="row form-group">
                <div class="col-md-12">
                  ...
                  <textarea name="message" id="message" cols="30" rows="7" class="form-control rounded-0" placeholder="écrivez vos notes ou questions ici..."></textarea>
                </div>
              </div>
