  ...
  <div class="site-wrap">
    ...
    <div class="site-section" id="products-section">
      <div class="container">
        ...
        <div class="row">
          <a href="commande/commande1.php?menu1=sandwichs1">
          <div class="col-lg-4 col-md-6 mb-5">
            <div class="product-item">
              ...
              <div class="px-4">
                ...
                <div>
                  <a href="commande/commande1.php?menu1=sandwichs1" class="btn btn-black mr-1 rounded-0">Voir</a>
                </div>
              </div>
            </div>
          </div>
          ...
          <a href="commande/commande1.php?menu2=sandwichs1">
          <div class="col-lg-4 col-md-6 mb-5">
            <div class="product-item">
              <figure>
              ...
              <div class="px-4">
                ...
                <p class="mb-4">Lorem ipsum dolor sit amet, consectetur adipisicing.</p>
                <div>
                  <a href="commande/commande1.php?menu2=sandwichs1" class="btn btn-black mr-1 rounded-0">Voir</a>
                </div>
              </div>
            </div>
          </div>
          ...
          <a href="commande/commande1.php?menu3=sandwichs1">
          <div class="col-lg-4 col-md-6 mb-5">
            <div class="product-item">
              <figure>
              ...
              <div class="px-4">
                ...
                <p class="mb-4">Lorem ipsum dolor sit amet, consectetur adipisicing.</p>
                <div>
                  <a href="commande/commande1.php?menu3=sandwichs1" class="btn btn-black mr-1 rounded-0">Voir</a>
                </div>
              </div>
            </div>
          </div>
          ...
          <a href="commande/commande1.php?menu4=sandwichs1">
            <div class="col-lg-4 col-md-6 mb-5">
              <div class="product-item">
                <figure>
                ...
                <div class="px-4">
                  ...
                  <p class="mb-4">Lorem ipsum dolor sit amet, consectetur adipisicing.</p>
                  <div>
                    <a href="commande/commande1.php?menu4=sandwichs1" class="btn btn-black mr-1 rounded-0">Voir</a>
                  </div>
                </div>
              </div>
            </div>
          ...
          <a href="commande/commande1.php?menu5=sandwichs1">
            <div class="col-lg-4 col-md-6 mb-5">
              <div class="product-item">
                <figure>
                ...
                <div class="px-4">
                  ...
                  <p class="mb-4">Lorem ipsum dolor sit amet, consectetur adipisicing.</p>
                  <div>
                    <a href="commande/commande1.php?menu5=sandwichs1" class="btn btn-black mr-1 rounded-0">Voir</a>
                  </div>
                </div>
              </div>
            </div>
          ...
          <a href="commande/commande1.php?menu6=sandwichs1">
          <div class="col-lg-4 col-md-6 mb-5">
            <div class="product-item">
              <figure>
              ...
              <div class="px-4">
                ...
                <p class="mb-4">Lorem ipsum dolor sit amet, consectetur adipisicing.</p>
                <div>
                  <a href="commande/commande1.php?menu6=sandwichs1" class="btn btn-black mr-1 rounded-0">Voir</a>
                </div>
              </div>
            </div>
          </div>
